...
var (
	...
	noAttachedCreditCardsMessage  = "\U0001FAE4 У вас нет привязанных кредитных карт." //nolint
	chooseCreditCardMessage       = "👀 Выберите кредитную карту для оплаты."           //nolint
	startRefuelingMessage         = "❓ Начать заправку?"
	stopRefuelingMessage          = "❗️ Нажмите кнопку, чтобы освободить колонку."
	refuelingProgressMessage      = "🕒 Пожалуйста, подождите. Заправка завершится в ближайшее время."
...
func (b *Bot) getStopMarkup() *tele.ReplyMarkup {
	...
	row := markup.Row(markup.Text("️🛑 Освободить колонку!"))
